...
import com.acme.insurance.telematics.service.TelematicsDataGenerator;
import com.acme.insurance.telematics.service.TelematicsPublisher;
import com.acme.insurance.telematics.service.WebSocketBroadcastService;
...
public class WebSocketController {
    ...
    public Object triggerSpecificAccident(String driverId) {
        ...
        if (success) {
            ...
            if (crashedDriver != null) {
                TelematicsMessage crashMessage = dataGenerator.generateCrashEventData(crashedDriver);
    ...
    private String getRouteDescription(com.acme.insurance.telematics.model.Driver driver) {
